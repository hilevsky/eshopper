...
<section>
    <div class="container">
        <div class="row">
            ...
            <h4>Редактировать товар № <?=$id?> <?=$product['name']?></h4>
            ...
            <div class="col-lg-4">
                <div class="login-form">
                    <form action="#" method="post" enctype="multipart/form-data">
                        ...
                        <p>Статус</p>
                        <select name="status">
                            <option value="1" <?if ($product['availability'] == 1) echo 'selected="selected"'?>>Отображается</option>
                            <option value="0" <?if ($product['availability'] == 0) echo 'selected="selected"'?>>Скрыт</option>
                        </select>
